...
Feature: Testing user play a turn in various scenarios
  ...
  Scenario: Play Turn - places multiple tiles but it is an invalid placement, tiles return to rack, places other tiles that form a run, then finishes turn


  Scenario: Play Turn - places multiple tiles but it is an invalid placement, tiles return to rack, places other tiles that form a group, then finishes turn
