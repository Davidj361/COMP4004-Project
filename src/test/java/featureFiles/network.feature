...
Feature: networkFeature, The game is networked and can have up to 4 players playing across the network
  ...
  Scenario: game starts, players play turns where Player 1 wins in 1 round
    ...
    And All players see the game's start text
    And The game has a game ending score at 5
    # Give 14 tiles to all players
    And Player 1 has "(3 red),(4 red),(5 red),(6 red),(7 red),(8 red),(9 red),(10 red),(3 black),(4 black),(5 black),(6 black),(7 black),(8 black)" on hand
    And Player 2 has "(1 red),(3 red),(5 red),(7 red),(9 red),(1 black),(3 black),(5 black),(7 black),(9 black),(1 yellow),(3 yellow),(5 yellow),(7 yellow)" on hand
    And Player 3 has "(1 red),(3 red),(5 red),(7 red),(9 red),(1 black),(3 black),(5 black),(7 black),(9 black),(1 yellow),(3 yellow),(5 yellow),(7 yellow)" on hand
    And Player 4 has "(1 red),(3 red),(5 red),(7 red),(9 red),(1 black),(3 black),(5 black),(7 black),(9 black),(1 yellow),(3 yellow),(5 yellow),(7 yellow)" on hand
